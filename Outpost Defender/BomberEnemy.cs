...
public class BomberEnemy : MonoBehaviour {
    ...
    //What should happen when enemy arrives at wall
    public void ArriveAtWall() {
        //Stops enemy from moving, even if its position is still being updated (because the direction vector is now 0,0)
